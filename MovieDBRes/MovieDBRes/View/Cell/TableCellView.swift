...
class TableCellView: UIView {
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            self.movieImage.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 16),
            ...
            self.titleLabel.leadingAnchor.constraint(equalTo: self.movieImage.trailingAnchor, constant: 10),
